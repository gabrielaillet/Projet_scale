...
def populate_database():
    ...
    Taf2 = taf(name="formation ingenieur etudiant", code="Fise", description=loremipsum)
    ...
    studentTaf2 = taf_student(student_id=2, taf_id=2, year=2022)
    ...
    db.session.commit()
    Student4 = student(name="Parey", surname="Alice")
    Profile4 = profile(student_id=4, email="test@gmail", etat_civil="Mr", post="étudiant")
    Prom4 = class_prom(student_id=4, year=2021)
    studentTaf4 = taf_student(student_id=4, taf_id=2, year=2021)
    db.session.add(Student4)
    db.session.add(Profile4)
    db.session.add(Prom4)
    db.session.commit()
    Student5 = student(name="Boelle", surname="Octave")
    studentTaf5 = taf_student(student_id=5, taf_id=2, year=2021)
    Profile5 = profile(student_id=5, email="test@gmail", etat_civil="Mr", post="étudiant")
    Prom5 = class_prom(student_id=5, year=2021)
    db.session.add(Student5)
    db.session.add(Profile5)
    db.session.add(Prom5)
    db.session.commit()
    Student6 = student(name="Dai", surname="Julien")
    studentTaf6 = taf_student(student_id=6, taf_id=2, year=2021)
    Profile6 = profile(student_id=6, email="test@gmail", etat_civil="Mr", post="étudiant")
    Prom6 = class_prom(student_id=6, year=2021)
    db.session.add(Student6)
    db.session.add(Profile6)
    db.session.add(Prom6)
    db.session.commit()
    Student7 = student(name="Souamie", surname="Lena")
    studentTaf7 = taf_student(student_id=7, taf_id=2, year=2022)
    Profile7 = profile(student_id=7, email="test@gmail", etat_civil="Mme", post="étudiant")
    Prom7 = class_prom(student_id=7, year=2022)
    db.session.add(Student7)
    db.session.add(Profile7)
    db.session.add(Prom7)
    db.session.commit()
    Student8 = student(name="Roche", surname="Emeline")
    studentTaf8 = taf_student(student_id=8, taf_id=2, year=2022)
    Profile8 = profile(student_id=8, email="test@gmail", etat_civil="Mr", post="étudiant")
    Prom8 = class_prom(student_id=8, year=2022)
    db.session.add(Student8)
    db.session.add(Profile8)
    db.session.add(Prom8)
    db.session.commit()
    db.session.add(studentTaf4)
    db.session.add(studentTaf5)
    db.session.add(studentTaf6)
    db.session.add(studentTaf7)
    db.session.add(studentTaf8)
    db.session.commit()
...
def editTaf(name,TafCode):
    if(name == "Admin"):
        ...
        if(Taf != None):
            if flask.request.method == 'GET':
                TafForm = TafFormWithDescription(taf_name=Taf.name, code=Taf.code, description=Taf.description)
